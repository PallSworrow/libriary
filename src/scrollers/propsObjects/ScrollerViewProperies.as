package scrollers.propsObjects 
{
	...
	public class ScrollerViewProperies 
	{
		...
		public var offsetY:int=20;//определяет смещение по вертикали
		...
		public var stiffDrag:Boolean = false;//жесткая привязка к указателю при драге. при false - скроллер будет догонять указатель(палец/мышь) так же как догоняет вой контроллер
