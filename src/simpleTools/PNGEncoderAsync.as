...
//    include "../../core/Version.as";
		 ...
		 *  @productversion Flex 3
		 */
		private var rowsByFrame:int
		public function PNGEncoderAsync(EncodeRowsByFrame:int)
		{
			super();
			rowsByFrame = EncodeRowsByFrame;
			initializeCRCTable();
		}
		 ...
		 *  @private
		 */
		private function internalEncode(source:Object, width:int, height:int, transparent:Boolean = true):void
		{
		...
		{
			for (var i:int = 0; i < rowsByFrame; i++)
			{
				writeRow();
				y++;
				if (y >= height)
